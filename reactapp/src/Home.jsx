    ...
    <div>
      <div className="wrapper">
        ...
        <div className="center">
          ...
          <Link to="/Task"><button className="btn2">Create Task</button></Link>
          <Link to="/View"><button className="btn2">View Task</button></Link>
          <Link to="/Edit"><button className="btn2">Edit Task</button></Link>
          <Link to="/Delete"><button className="btn2">Delete Task</button></Link>
