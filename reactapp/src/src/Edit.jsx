...
//         <h1 className="form-title">TASK UPDATION</h1>
...
//       type: e.target.elements.taskType.value,
...
//     axios
//       .put(`http://127.0.0.1:8181/put`, taskData)
//       .then((response) => {
//         setTaskUpdated(true);
//       })
//       .catch((error) => {
...
function Edit() {
  ...
  const handleCreateTask = async (e) => {
    ...
    try {
      await axios.put('http://127.0.0.1:8181/put', taskData, {
        headers: {
